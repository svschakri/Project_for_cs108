...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth, trim = 2 0 40 0, clip]{authenticator}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{start_menu}
    \caption{Authenticator window in terminal}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{tictactoe}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{othello}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{connect4}
